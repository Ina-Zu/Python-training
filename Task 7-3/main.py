...
def manual_input():
    ...
    if choice == "1":
        News(input("Enter news text: "), input("Enter city: ")).save()
    elif choice == "2":
        PrivateAd(input("Enter ad text: "), input("Enter expiration date YYYY-MM-DD: ")).save()
    elif choice == "3":
        MotivationalQuote(input("Enter quote: "), input("Enter author: ")).save()
    else:
